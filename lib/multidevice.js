    ...
    return function (client) {
        ...
        client.next = function() {
            ...
            return this.lastPromise.done(function() {
                ...
                let usedBrowserNames = browserNames

                if (addressOptions.implicit && fnName == "click") {
                    usedBrowserNames = ['A']
                }

                console.log("Execute command", fnName, "on", usedBrowserNames, addressOptions)

                usedBrowserNames.forEach(function(browserName) {
                    instance = multiDevice.instances[browserName];
