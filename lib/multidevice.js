...
let elementSelectorCommands = ['addValue', 'chooseFile', 'clearElement', 'click', 'doubleClick', 'getAttribute',
    'getCssProperty', 'getElementSize', 'getHTML', 'getLocation', 'getLocationInView', 'getTagName', 'getText',
    'getValue', 'hold', 'moveToObject', 'release', 'selectorExecute', 'selectorExecuteAsync', 'setValue', 'submitForm',
    'touch']
let implicitCommands = elementSelectorCommands
