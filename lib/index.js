        ...
        files.forEach(function(filename) {
            ...
            let proxyCommandFunc = function () {
                ...
                if (commandName === 'end' || commandName == 'endAll') {
                    ...
                    // Remove illegal file name chars, remove anything that is not alphanumeric
                    let fileName = flowName.replace(/[^a-z0-9]/gi, '_').toLowerCase()
                    flow.storeIfChanged('flow_' + fileName + '.json')
