...
function remote(options, modifier, multiDevice, flow, addressingOptions) {
    ...
    ;['protocol', 'commands'].forEach(function(commandType) {
        ...
        files.forEach(function(filename) {
            ...
            var newObject = JSON.parse(JSON.stringify(addressingOptions));
            ...
            let proxyCommandFunc = function () {
                ...
                let implicitDeviceSelection = false
                if (addressingOptions.implicit && commandName == "click") {
                    implicitDeviceSelection = true
                }
