...
function waitUntilPrivate(condition, timeout, interval, starttime, abortCallback) {
    var self = this,
        defer = q.defer(),
        promise;
...
module.exports = function waitUntil(condition, timeout, interval, abortCallback) {
    /*!
    ...
    console.log("called custom waitUntil")
    ...
    return waitUntilPrivate.call(this, condition, timeout, interval, starttime, abortCallback);
};
